...
<html>
	...
	<body>
        ...
        <?php echo form_open('crud/profil?todo=update&is=pass');?>
            <input name="pasf" type="password" placeholder="Type New Password" required><br>
            <input name="pass" type="password" placeholder="Re-Type New Password" required><br>
            <fieldset>
                <legend>Password Last</legend>
                <input name="pasl" type="password" placeholder="Last Password" required><br>
            </fieldset>
