		...
		<div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                            <a href="<?php echo base_url('index.php/dashboard/tuju');?>"><button class="btn btn-warning pull-right">Back</button></a>
                                <h4 class="title">Tujan Transmigrasi</h4>
                            </div>
            <?php if(isset($_GET['id']))$lnk = "$_GET[todo]&id=$_GET[id]";
                else $lnk = "$_GET[todo]";
                echo form_open("crud/tuju?todo=$lnk");?>
                            <div class="content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><i class="ti-location-pin"></i> Lokasi</label>
                                                <input type="text" name="lokasi" value="<?php if($edit){echo $user['lok'];} ?>" class="form-control border-input" placeholder="Lokasi" required>
                                            </div>
                                        </div>
                                    </div><div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><i class="ti-map-alt"></i> Kota</label>
                                                <input type="text" name="kota" value="<?php if($edit){echo $user['kab'];} ?>" class="form-control border-input" placeholder="Kabupaten/kota" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><i class="ti-map"></i> Provinsi</label>
                                                <input type="text" name="provinsi" value="<?php if($edit){echo $user['prov'];} ?>" class="form-control border-input" placeholder="Provinsi" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><i class="ti-calendar"></i> Tahun</label>
                                                <input type="text" name="tahun" value="<?php if($edit){echo $user['tahun'];} ?>" class="form-control border-input" placeholder="Tahun" onkeypress="return number(event);" required>
                                            </div>
                                        </div>
                                    </div>
