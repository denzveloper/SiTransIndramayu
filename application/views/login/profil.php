                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="card card-user">
							...
							<div class="footer">
                                <hr />
                                <div class="stats">
                                    <a href="<?php echo base_url('index.php/dashboard/sandi');?>"><i class="ti-unlock"></i> Edit Sandi</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="fnam" value="<?php echo $user->namadepan; ?>" type="text" class="form-control border-input" placeholder="First Name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Akhir</label>
                                                <input name="lnam" type="text" value="<?php echo $user->namabelakang; ?>" class="form-control border-input" placeholder="Last Name" required>
                                            </div>
                                        </div>
                                    </div>
